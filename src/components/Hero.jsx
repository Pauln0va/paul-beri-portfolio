      ...
      <div className="w-full flex flex-col gap-24">
        <div className="flex flex-col gap-4 justify-center items-center pt-6">
          ...
          <div className="flex flex-col gap-1 items-center">
            ...
            <h2 className="font-normal text-gray-600 text-sm sm:text-base font-sans sm:tracking-wider">Welcome to my portfolio!</h2>
          </div>
        </div>
        <div className="flex relative w-full justify-evenly items-center gap-8 bg-stone-100 px-8">
          <div className="flex flex-col gap-8 z-10 border-l pl-8 border-gray-400">
            ...
            <p className="max-w-132 min-w-64 font-extralight tracking-wider text-sm text-gray-600 text-justify">
              I am a <span className="font-bold text-[#e03131]">UX</span> designer,
              <span className="font-bold text-red-600"> Graphics</span> designer and
              a <span className="font-bold text-red-600">Frontend Web </span>
